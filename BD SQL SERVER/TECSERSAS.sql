--Creación base de datos TECSERSAS--
...
-- Creación de la tabla Detalle Pedido Producto
...
-- Creación de la tabla Detalle Servicio Factura
...
--Inserción base de datos TECSERSAS--
...
(34567, 'Mayorista', 'Tecsersas S.A.S.', 'Calle 10 # 50-40, Bogotá', 3105551234, 'contacto@tecsersas.com', 'Pago al contado o crédito a 30 días', 'Primer día de cada mes'),
(98909, 'Minorista', 'Distribuciones Tec', 'Carrera 7 # 34-20, Bogotá', 3105554321, 'ventas@distribuciontec.com', 'Pago inmediato', 'Quincenal'),
(26786, 'Mayorista', 'Soluciones y Tecnología', 'Avenida 9 # 12-30, Medellín', 3005559876, 'info@solutec.com', 'Pago a 60 días', 'Último día de cada mes'),
(76785, 'Minorista', 'TecnoProveedores', 'Calle 5 # 23-45, Cali', 3205556543, 'contacto@tecnoproveedores.com', 'Pago por consignación', 'Primero de cada mes'),
(65389, 'Mayorista', 'Proveedor Universal', 'Carrera 13 # 15-60, Barranquilla', 3115558976, 'proveedor@universal.com', 'Pago a 30 días', 'Quincenal');
...
(15678, 'Industrias Romero', '800456789', 'Carrera 1 # 10-20, Bogotá', 3005551234, 'Romero@gmail.com'),
(98767, 'María Gómez', 'N/A', 'Calle 5 # 30-50, Medellín', 3005555678, 'mariagomez@gmail.com'),
...
(15212, 'Geotermica SAS', '800654321', 'Calle 8 # 20-15, Bogotá', 3105559876, 'geotermica@gmail.com');
...
(101, '2024-12-01', 'Instalación de Red', 200000.00, 'Servicio de instalación de redes locales (LAN) para empresas.', 'Activo'),
(102, '2024-12-02', 'Mantenimiento de Equipos', 150000.00, 'Mantenimiento preventivo y correctivo para equipos informáticos.', 'Activo'),
(103, '2024-12-03', 'Asesoría en Seguridad Informática', 250000.00, 'Consultoría en implementación de soluciones de seguridad informática.', 'Activo'),
(104, '2024-12-04', 'Desarrollo de Software', 500000.00, 'Creación de software personalizado según necesidades del cliente.', 'Inactivo'),
(105, '2024-12-05', 'Soporte Técnico Remoto', 100000.00, 'Atención a incidencias y soporte remoto para usuarios finales.', 'Activo');
...
(45345, 'Luis Pérez', 'Carrera 8 # 23-45, Bogotá', 3105552345, 'luisperez@email.com', '9:00 AM - 6:00 PM', 1500000.00, 101),
(12678, 'Pedro González', 'Calle 10 # 15-30, Medellín', 3105559876, 'pedrogonzalez@email.com', '9:00 AM - 6:00 PM', 1400000.00, 102),
(45908, 'María Rodríguez', 'Avenida 5 # 30-60, Cali', 3205558765, 'mariarodriguez@email.com', '9:00 AM - 6:00 PM', 1300000.00, 103),
(23567, 'Carlos Díaz', 'Carrera 3 # 10-20, Barranquilla', 3105554321, 'carlosdiaz@email.com', '9:00 AM - 6:00 PM', 1450000.00, 104),
(90890, 'Ana González', 'Calle 12 # 20-40, Bogotá', 3105551234, 'anagonzalez@email.com', '9:00 AM - 6:00 PM', 1600000.00, 105);
...
(101, 'Router TP-Link Archer AX50', 450000.00, 'Tecnología', 'Router Wi-Fi 6 de alto rendimiento', 101, 34567),
(102, 'Computadora Dell OptiPlex 7070', 3200000.00, 'Tecnología', 'Computadora de escritorio para uso empresarial', 102, 98909),
(103, 'Monitor LG 27GL850-B', 1800000.00, 'Tecnología', 'Monitor IPS 27" para profesionales y gamers', 103, 26786),
(104, 'Laptop HP EliteBook 840', 3500000.00, 'Tecnología', 'Laptop empresarial con alto rendimiento y seguridad', 104, 76785),
(105, 'Impresora HP LaserJet Pro M404n', 900000.00, 'Tecnología', 'Impresora láser monocromática para oficinas', 105, 65389);
...
(101, 'Instalación', 101, 101),
(102, 'Mantenimiento', 102, 102),
(103, 'Asesoría', 103, 103),
